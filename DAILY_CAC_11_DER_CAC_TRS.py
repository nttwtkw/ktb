...
with DAG('DAILY_CAC_11_DER_CAC_TRS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 1.1 FX Credit Account',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CAC11CAC_LOAD_TRS01',
        python_callable=CAC11CAC_LOAD_TRS01
    )
