...
with DAG('DAILY_CAC_16_DER_FXL_CMS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 1.6 FX Loan CMS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CAC16FXL_LOAD_CMS01',
        python_callable=CAC16FXL_LOAD_CMS01
    )
