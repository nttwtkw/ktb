...
with DAG('DAILY_CMM_74_DER_OTDD_TRS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.4 Outstanding Daily TRS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM74OTDD_LOAD_TRS01',
        python_callable=CMM74OTDD_LOAD_TRS01
    )
