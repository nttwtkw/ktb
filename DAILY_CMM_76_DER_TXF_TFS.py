...
def CMM76TXF_LOAD_TFS01():
    try:
        #read config files
        config = function.read_config_psql('DER_TXF_D')
...
with DAG('DAILY_CMM_76_DER_TXF_TFS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.6 Transaction Flow TFS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM76TXF_LOAD_TFS01',
        python_callable=CMM76TXF_LOAD_TFS01
    )
