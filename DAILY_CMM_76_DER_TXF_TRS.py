...
with DAG('DAILY_CMM_76_DER_TXF_TRS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.6 Transaction Flow TRS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM76TXF_LOAD_TRS01',
        python_callable=CMM76TXF_LOAD_TRS01
    )
