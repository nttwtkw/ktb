...
with DAG('DAILY_CMM_77_DER_RLI_CMS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.7 Related Loan or Investment CMS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM77RLI_LOAD_CMS01',
        python_callable=CMM77RLI_LOAD_CMS01
    )
