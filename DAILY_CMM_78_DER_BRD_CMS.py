...
with DAG('DAILY_CMM_78_DER_BRD_CMS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.8 BOT Reference Document CMS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM78BRD_LOAD_CMS01',
        python_callable=CMM78BRD_LOAD_CMS01
    )
