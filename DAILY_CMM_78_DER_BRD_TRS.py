...
with DAG('DAILY_CMM_78_DER_BRD_TRS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.8 BOT Reference Document TRS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM78BRD_LOAD_TRS01',
        python_callable=CMM78BRD_LOAD_TRS01
    )
