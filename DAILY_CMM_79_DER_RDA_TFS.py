...
with DAG('DAILY_CMM_79_DER_RDA_TFS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 7.9 Related Deposit Account TFS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='CMM79RDA_LOAD_TFS01',
        python_callable=CMM79RDA_LOAD_TFS01
    )
