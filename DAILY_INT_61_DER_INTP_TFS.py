...
def INT61INTP_LOAD_TFS01():
    try:
        #read config files
        config = function.read_config_psql('DER_INT_D')
...
with DAG('DAILY_INT_61_DER_INTP_TFS',
    ...
    task1 = PythonOperator(
        task_id='INT61INTP_LOAD_TFS01',
        python_callable=INT61INTP_LOAD_TFS01
    )
