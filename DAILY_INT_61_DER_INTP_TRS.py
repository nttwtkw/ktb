...
def INT61INTP_LOAD_TRS01():
    ...
    #mock data
    df['fix_rate_qted_fm_refr_rate_id'] = '999999999'
...
with DAG('DAILY_INT_61_DER_INTP_TRS',
    ...
    task1 = PythonOperator(
        task_id='INT61INTP_LOAD_TRS01',
        python_callable=INT61INTP_LOAD_TRS01
    )
