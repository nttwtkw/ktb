...
with DAG('DAILY_INT_62_DER_INTR_CMS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 6.2 Interest Reference CMS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='INT62INTR_LOAD_CMS01',
        python_callable=INT62INTR_LOAD_CMS01
    )
