...
def INT62INTR_LOAD_TRS01():
    ...
    #mock data
    df['bot_doc_tp'] = '999999999'
    df['bot_doc_no'] = '999999999'
...
with DAG('DAILY_INT_62_DER_INTR_TRS',
         schedule_interval='@daily', 
         default_args=default_args,
         description='Daily: 6.2 Interest Reference TRS',
         catchup=False) as dag:
 
    task1 = PythonOperator(
        task_id='INT62INTR_LOAD_TRS01',
        python_callable=INT62INTR_LOAD_TRS01
    )
