...
with DAG('DAILY_INT_63_DER_INTRV_CMS',
    ...
    task1 = PythonOperator(
        task_id='INT63INTRV_LOAD_CMS01',
        python_callable=INT63INTRV_LOAD_CMS01
    )
